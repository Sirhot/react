...
var Person = /*#__PURE__*/function () {
  function Person() {
    var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Adam";
  ...
  _createClass(Person, [{
    key: "findAge",
    value: function findAge() {
      return new Date().getFullYear() - this.year;
    }
  }, {
    key: "salute",
    value: function salute(text) {
      return "Hi ".concat(text, ", greetings from ").concat(this.name);
    }
  }]);
...
var Student = /*#__PURE__*/function (_Person) {
  ...
  function Student(name, year, studentId) {
    var _this;
  ...
  _createClass(Student, [{
    key: "salute",
    value: function salute(text) {
      return _get(_getPrototypeOf(Student.prototype), "salute", this).call(this, text) + " the student.";
    }
  }]);
...
var Teacher = /*#__PURE__*/function (_Person2) {
  ...
  _createClass(Teacher, [{
    key: "salute",
    value: function salute(text) {
      return _get(_getPrototypeOf(Teacher.prototype), "salute", this).call(this, text) + " the teacher.";
    }
  }]);
...
var p = new Person("Axz", 2000);
var p2 = new Person();
var p3 = new Student("Alex", 2003, 312);
var p4 = new Teacher("Cana", 1980, "Physics");
